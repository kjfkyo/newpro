...
<div id="schoolModal" class="am-u-sm-12 am-u-md-12 am-u-lg-12" style="display: none;">
    <div class="widget am-cf">
        <div class="widget-body am-fr">
            <form id="schoolForm" class="layui-form am-form tpl-form-border-form tpl-form-border-br"
                  action="${ctx}/school/save"
                  method="post">
                <input type="hidden" id="xxid" name="id" value="">
                <div class="am-form-group">
                    <label for="name" class="am-u-sm-3 am-form-label">高校名称<span
                 ...
                 <div class="am-form-group">
                    <label for="zt" class="am-u-sm-3 am-form-label">状态<span
                            class="tpl-form-line-small-title">*</span></label>
                    <div class="am-u-sm-9">
                ...
                <div class="am-form-group">
                    <label for="zw" class="am-u-sm-3 am-form-label">职务<span
                            class="tpl-form-line-small-title"></span></label>
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="zw" name="zw"
                               placeholder="请输入联系人职务" lay-verify="zw">
                    </div>
                </div>
                <div class="am-form-group">
                    <label for="cc" class="am-u-sm-3 am-form-label">层次<span
                            class="tpl-form-line-small-title"></span></label>
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="cc" name="cc"
                               placeholder="请输入层次" >
                    </div>
                </div>

                <div class="am-form-group">
                    <label for="lx" class="am-u-sm-3 am-form-label">类型<span
                            class="tpl-form-line-small-title"></span></label>
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="lx" name="lx"
                               placeholder="请输入类型">
                    </div>
               	</div>
                <div class="am-form-group">
                ...
                <div class="am-form-group">
                    <label for="zybz" class="am-u-sm-3 am-form-label">专业比重<span
                            class="tpl-form-line-small-title"></span></label>
                    <div class="am-u-sm-9" >
                        <input type="text" class="tpl-form-input" id="zybz"
                               name="zybz" placeholder="请输入专业比重"/>
                    </div>
                </div>
                <div class="am-form-group">
                ...
                <div class="am-form-group">
                    <div class="am-u-sm-9 am-u-sm-push-3">
                        <button lay-submit lay-filter="schoolForm"
...
<script>
    ...
    form.verify({
    	name: function (value, item) {//value:表单值，item:表单dom对象
            ...
            if (value.trim().length > 48) {
                return "高校名称最多输入48个字符哦";
            }
            /* var flag = false;
            $.ajax({
                url: "${ctx}/school/checkName",
        ...
        lxr: function (value, item) {//value:表单值，item:表单dom对象
        	if (value == null || value.trim().length <= 0) {
                return "联系人必须输入的哦";
            }
        },
    ...
    form.on('submit(schoolForm)', function (data) {
        $.ajax({

            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <ol class="am-breadcrumb">
                        <li><a href="${ctx}/clzss/list" class="am-icon-home">项目组详细</a></li>
                        ...
                        <div class="am-u-sm-12">
                            <table width="100%"
                                ...
                                <c:if test="${empty stus.results}" >
                                	<tr>
                                		<td colspan="8" class="am-text-middle">暂无记录</td>
                                	</tr>
                                </c:if>
                                <c:if test="${!empty stus.results}" >
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td>
	                                            <div class="tpl-table-black-operation">
	                                                <a href="javascript:;" onclick="editStu('${stu.ID}','${stu.CID}')"> <i
	                                                        class="am-icon-pencil"></i>换项目组
	                                                </a> 
	                                                <!--  

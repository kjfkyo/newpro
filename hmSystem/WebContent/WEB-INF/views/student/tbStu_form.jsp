...
<div id="tBasiStudentModal" class="am-u-sm-12 am-u-md-12 am-u-lg-12" style="display: none;">
    <div class="widget am-cf">
        <div class="widget-body am-fr">
            <form id="tBasiStudentForm" class="layui-form am-form tpl-form-border-form tpl-form-border-br"
                  action="${ctx}/tBasiStudent/updateSave"
                  method="post">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9" style="width:30%">
                        <select id="channel" onchange="initChannel(this)" lay-ignore name="channel" lay-search style="display: none;">
